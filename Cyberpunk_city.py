...
background = pygame.image.load("cyberpunk_city.png")  # Make sure you have an image file
...
locations = [
    {"name": "Neon Alley", "event": "A hacker offers you stolen data.", "x": 450, "y": 350},
    {"name": "Synth Bar", "event": "A rogue AI whispers cryptic warnings.", "x": 400, "y": 300},
    {"name": "Corporate Tower", "event": "A megacorp exec wants a deal.", "x": 600, "y": 100},
    {"name": "Underground Market", "event": "A cyber-merchant sells black-market cards.", "x": 300, "y": 450},
]
...
def game_loop():
    ...
    while running:
        ...
        draw_text("CYBERPUNK CITY - EXPLORE", 50, 50, NEON_BLUE)
        ...
        if current_location:
            ...
            draw_text("Move closer to a location...", 50, HEIGHT - 50, NEON_BLUE)
